...
import org.apache.commons.io.IOUtils;
 ...
 class Example {
    ...
    private static void processAudioFile(File file) throws IOException, UnsupportedAudioFileException {
        ...
        byte[] audioBytes = convertAudioFileToByteArray(file);
        ...
        long totalSilenceDuration = 0,ct=0;
    ...
    private static byte[] convertAudioFileToByteArray(File file) throws IOException, UnsupportedAudioFileException {
